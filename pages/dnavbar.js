    ...
    <div className={folio.MainPageFolio}>
      ...
      <span className={folio.mypro}> <u>Portfolio</u></span>
          ...
          <div className={folio.rightdiv}>
                        ...
                        <img src={'/divya.jpg.jpeg'} alt="Divya" id={folio.Image} height={370} width={300}/>
                    </div>
        </div>
      </div>
      ...
      <div ref={About} className={folio .About }>
            <div className={folio .About11}>
              <div className={folio .iphone}>
                <h1 id={folio .HH1}><u>About Me</u></h1>
      
                <p id={folio .PAGE12}>
                Hello, I'm Divya Bagwan, a seasoned Flutter developer with  dedicated experience crafting 
                dynamic and visually stunning cross-platform mobile applications. Throughout my journey in the field,
                ...
                Let's collaborate to bring your next app idea to life with the magic of Flutter!
          ...
          <h1 id={folio .HH2}><u>Skills</u></h1><br></br><br></br>
...
<Image src={'/Weather.jpg'} alt="Denim Jeans" width={500} height={350}/>
...
<div class={folio .Card}>
<Image src={'/Blogpost.jpg'} alt='Divya' width={500} height={350} />
...
<div class={folio .Card}>
<Image src={'/filipkart.jpg'} alt='Divya' width={500} height={350} />
...
<div class={folio .Card}>
<Image src={'/netflix.jpg'} alt='Divya' width={500} height={350}/>
...
<p id={folio .PPage}>The Netflix clone project is a web application developed using HTML, CSS, and JavaScript, aiming to replicate
 ...
 into its key components and functionalities.  </p>
   ...
   <input className={folio. types} type='texe' placeholder='Your Name' /><br></br><br></br>
   <input className={folio. types} type='emali' placeholder='Your Email '/><br></br><br></br>
   <input  className={folio. typesEmail}type='texe' placeholder='Your Message' /><br></br><br></br>
